...
<div class="col-12">
    <div class="card">
        <div class="col-lg-2 card-header">
            <a href="{{route('admin.abouts.create')}}" class="btn btn-block bg-gradient-primary">Create About</a>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
                    ...
                    <table id="example2" class="table table-bordered table-hover dataTable dtr-inline" role="grid" aria-describedby="example2_info">
                       <thead>
                          <tr role="row">
                             ...
                             <th class="sorting sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Browser: activate to sort column descending" aria-sort="ascending">Main information</th>
                       ...
                       <tbody>
                          ...
                          <tr class="odd">
                            ...
                            <td class="project-state">
                             ...
                             <td class=""><img src="/admin/images/about/{{$item->image}}" width="100px" alt="" srcset=""></td>
                             <td class="project-actions text-right dtr-control">

                                <a class="btn btn-info btn-sm col-md-10" href="{{route('admin.abouts.edit', $item->id)}}">
