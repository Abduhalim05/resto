...
<div class="col-12">
    <div class="card">
        <div class="col-lg-2 card-header">
            <a href="{{route('admin.meals.create')}}" class="btn btn-block bg-gradient-primary">Create meal</a>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
                    ...
                    <table id="example2" class="table table-bordered table-hover dataTable dtr-inline" role="grid" aria-describedby="example2_info">
                       ...
                       <tbody>
                          ...
                          <tr class="odd">
                             ...
                             <td class="sorting_1">{{$meal->name}}</td>
                            <td class="project-state">
                             ...
                             <td class=""><img src="/admin/images/meals/{{$meal->image}}" width="100px" alt="" srcset=""></td>
                             <td class="project-actions text-right dtr-control">
                                <a class="btn btn-primary btn-sm col-md-10" href="{{route('admin.meals.show', $meal->id)}}">
                                    <i class="fas fa-folder">
                                    </i>
                                    View
                                </a>
                                <a class="btn btn-info btn-sm col-md-10" href="{{route('admin.meals.edit', $meal->id)}}">
