...
<div class="col-12">
    <div class="card">
        <div class="col-lg-2 card-header">
            <a href="{{route('admin.teams.create')}}" class="btn btn-block bg-gradient-primary">Add teamers</a>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
                    ...
                    <table id="example2" class="table table-bordered table-hover dataTable dtr-inline" role="grid" aria-describedby="example2_info">
                       <thead>
                          <tr role="row">
                             ...
                             <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">Job</th>
                       ...
                       <tbody>
                          ...
                          <tr class="odd">
                             ...
                             <td class="sorting_1">{{$item->job}}</td>

                             <td class=""><img src="/admin/images/team/{{$item->image}}" width="100px" alt="" srcset=""></td>
                             <td class="project-actions text-right dtr-control">
                                <a class="btn btn-primary btn-sm col-md-10" href="{{route('admin.teams.show', $item->id)}}">
                                    <i class="fas fa-folder">
                                    </i>
                                    View
                                </a>
                                <a class="btn btn-info btn-sm col-md-10" href="{{route('admin.teams.edit', $item->id)}}">
